...
public class WebserviceProdProvider implements Provider<IWebservice> {

	private static final Logger LOGGER = LoggerFactory.getLogger(WebserviceProdProvider.class);
